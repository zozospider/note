...
imac:~ yh$ 
imac:~ yh$ ls -l /System/Library/Frameworks/Python.framework/Versions/
total 0
...
imac:~ yh$ ls -l /System/Library/Frameworks/Python.framework/Versions/2.7/bin/
total 48
...
imac:~ yh$ 
imac:~ yh$ ls -l /Library/Frameworks/Python.framework/Versions/
total 0
drwxrwxr-x  12 root  admin  384 Nov 16 09:23 3.9
lrwxr-xr-x   1 root  wheel    3 Nov 14 16:57 Current -> 3.9
imac:~ yh$ 
imac:~ yh$ ls -l /Library/Frameworks/Python.framework/Versions/3.9/bin/
total 152
...
imac:~ yh$ python --version
Python 2.7.10
imac:~ yh$ python3 --version
Python 3.9.0
imac:~ yh$ whereis python
/usr/bin/python
imac:~ yh$ whereis python3
imac:~ yh$ 

imac:~ yh$ ls -l /usr/bin/py*
...
imac:~ yh$ 
imac:~ yh$ ls -l /Library/Frameworks/Python.framework/Versions/3.9/bin/py*
...
imac:~ yh$ whereis idle
/usr/bin/idle
imac:~ yh$ whereis idle3
imac:~ yh$ 

imac:~ yh$ ls -l /usr/bin/idle*
...
imac:~ yh$ 
imac:~ yh$ ls -l /Library/Frameworks/Python.framework/Versions/3.9/bin/idle*
