...
- [一 典型应用场景及实现](#一-典型应用场景及实现)
    - [1.1 数据发布/订阅](#11-数据发布订阅)
        - [1.1.1 ZooKeeper 应用示例](#111-zookeeper-应用示例)
    - [1.2 负载均衡](#12-负载均衡)
        - [1.2.1 ZooKeeper 应用示例](#121-zookeeper-应用示例)
    - [1.3 命名服务](#13-命名服务)
        - [1.3.1 ZooKeeper 应用实例](#131-zookeeper-应用实例)
    - [1.4 分布式协调/通知](#14-分布式协调通知)
        - [1.4.1 ZooKeeper 应用实例](#141-zookeeper-应用实例)
        - [1.4.2 分布式系统机器间通信](#142-分布式系统机器间通信)
    - [1.5 集群管理](#15-集群管理)
        - [1.5.1 ZooKeeper 应用示例: 分布式日志收集系统](#151-zookeeper-应用示例-分布式日志收集系统)
        - [1.5.2 ZooKeeper 应用示例: 在线云主机管理](#152-zookeeper-应用示例-在线云主机管理)
    - [1.6 Master 选举](#16-master-选举)
    - [1.7 分布式锁](#17-分布式锁)
        - [1.7.1 排他锁](#171-排他锁)
        - [1.7.2 共享锁](#172-共享锁)
        - [1.7.3 羊群效应](#173-羊群效应)
    - [1.8 分布式队列](#18-分布式队列)
        - [1.8.1 分布式屏障](#181-分布式屏障)
- [二. ZooKeeper在大型分布式系统中的应用](#二-zookeeper在大型分布式系统中的应用)
    - [2.1 Hadoop](#21-hadoop)
        - [2.1.1 YARN 介绍](#211-yarn-介绍)
        - [2.1.2 ResourceManager(RM) 单点问题](#212-resourcemanagerrm-单点问题)
    - [2.2 HBase](#22-hbase)
        - [2.2.1 系统冗错](#221-系统冗错)
        - [2.2.2 RootRegion 管理](#222-rootregion-管理)
        - [2.2.3 Region 状态管理](#223-region-状态管理)
        - [2.2.4 分布式 SplitLog 任务管理](#224-分布式-splitlog-任务管理)
        - [2.2.5 Replication 管理](#225-replication-管理)
        - [2.2.6 ZooKeeper 部署](#226-zookeeper-部署)
    - [2.3 Kafka](#23-kafka)
        - [2.3.1 术语介绍](#231-术语介绍)
        - [2.3.2 Broker 注册](#232-broker-注册)
        - [2.3.3 Topic 注册](#233-topic-注册)
        - [2.3.4 生产者负载均衡](#234-生产者负载均衡)
        - [2.3.5 消费者负载均衡](#235-消费者负载均衡)
- [三. ZooKeeper在阿里巴巴的实践与应用](#三-zookeeper在阿里巴巴的实践与应用)
    - [3.1 案例1 消息中间件: Metamorphosis](#31-案例1-消息中间件-metamorphosis)
    - [3.2 案例2 RPC服务款姐: Dubbo](#32-案例2-rpc服务款姐-dubbo)
    - [3.3 案例3 基于MySQL Binlog的增量订阅和消费组件: Canal](#33-案例3-基于mysql-binlog的增量订阅和消费组件-canal)
    - [3.4 案例4 分布式数据库同步系统: Otter](#34-案例4-分布式数据库同步系统-otter)
    - [3.5 案例5 轻量级分布式通用搜索平台: 终搜](#35-案例5-轻量级分布式通用搜索平台-终搜)
    - [3.6 案例6 实时计算引擎: JStorm](#36-案例6-实时计算引擎-jstorm)
